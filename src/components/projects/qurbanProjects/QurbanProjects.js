      ...
      <div className="zakat" id=" zakat">
        <div className="container">
          ...
          <div className="row ramadan__project-row">
            {qurbanProjects.map((project) => (
              <div className="col-md-6 col-12 mb-5" key={project._ID}>
                <Link
                  to={`/qurban/${project.slug}`}
