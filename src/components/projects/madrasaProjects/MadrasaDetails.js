...
function MadrasaDetails() {
  ...
  const { madrasaProjects } = useContext(StateContext);

  useEffect(() => {
    const singleProject = madrasaProjects.map((project) => {
  ...
  return (
    <div className="details">
      <Helmet>
        ...
        <meta
          name="description"
          content="Mosque and Madrasa based projects of Sadaqah Made Easy - SME"
        />
        <meta property="og:image" content={details.projectImg} />
      </Helmet>
      <img
      ...
      <div className="bg-light rounded shadow p-4">
        ...
        <h5 className="text-dark">
          ...
          additional referenece when sending sadaqah.
        </h5>
      </div>
